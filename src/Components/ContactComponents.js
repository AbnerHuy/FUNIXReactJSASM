...
import { Breadcrumb, BreadcrumbItem, Button, ButtonGroup, Label, Col, Row, CarouselControl, } from 'reactstrap';
...
class Contact extends Component {
    ...
    handelSubmit(value) {
        console.log("Current State in :" + JSON.stringify(value));
        alert("Current State in :" + JSON.stringify(value));
    }
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        messages={{
                                            required: "Required",
                                            minLength: "Must be gretear than 2 character",
                                ...
                                <Col md={10}>
                                    ...
                                    />
                                     <Errors
                                        ...
                                        messages={{
                                            required: "Required",
                                            minLength: "Must be gretear than 2 number",
